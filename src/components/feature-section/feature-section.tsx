  ...
  return (
    <section className="container bg-gray-700 grid gap-6 md:grid-cols-2 pb-8 pt-8 md:py-10">
      <div className="flex flex-col gap-4 rounded-lg p-6 bg-gray-500 md:p-12">
        ...
        <h2 className="text-gray-100 text-heading-lg lg:w-[26rem] font-sans">
      ...
      <div className="flex flex-col gap-4 rounded-lg p-6 bg-gray-500 md:p-12">
        ...
        <h2 className="text-gray-100 text-heading-lg lg:w-[25rem] font-sans">
          Venda para seu público através de uma plataforma única
        </h2>
      </div>

      <div className="col-span-full flex flex-col gap-2">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-4 rounded-lg p-6 bg-gray-500 md:p-12">
          <div className="flex flex-col gap-4">
            <span className="text-body-tag text-blue-200 bg-blue-400 px-2 py-1 w-fit rounded-sm uppercase">
              Personalizável
            </span>

            <h2 className="text-gray-100 text-heading-lg lg:w-[20rem] font-sans">
